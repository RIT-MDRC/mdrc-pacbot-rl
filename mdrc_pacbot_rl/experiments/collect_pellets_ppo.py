"""
Experiment for testing if the agent can learn to collect all pellets.
...
env = SyncVectorEnv([lambda: GetAllPelletsEnv() for _ in range(num_envs)])
test_env = GetAllPelletsEnv()
...
wandb.init(
    ...
    entity="mdrc-pacbot",
    config={
        "experiment": "collect pellets ppo",
        "num_envs": num_envs,
