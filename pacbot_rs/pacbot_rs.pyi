...
class ParticleFilter:
    def __init__(self, pacbot_x: int, pacbot_y: int, pacbot_angle: float): ...
    ...
    def get_pose(self) -> tuple[tuple[float, float], float]: ...
    def get_sense_distances(self) -> list[float]: ...
    def update(
        self, magnitude: float, direction: float, sensors: list[float]
    ) -> tuple[tuple[float, float], float]: ...
    def set_pose(self, x: float, y: float, angle: float) -> None: ...
    def rcv_position(self, x: float, y: float) -> None: ...
