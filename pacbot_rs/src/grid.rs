...
pub static GRID: [[GridValue; GRID_HEIGHT]; GRID_WIDTH] = include!("grid_data.txt");
...
pub static NODE_COORDS: [(usize, usize); NUM_NODES] = include_generated!("NODE_COORDS.rs");

assert_eq_size!(usize, u64);
static COORDS_TO_NODE: phf::Map<u128, usize> = include_generated!("COORDS_TO_NODE.rs");
...
pub static NODE_EMBEDDINGS: [[f32; EMBED_DIM]; NUM_NODES] = include_generated!("NODE_EMBEDDINGS.rs");

pub static VALID_ACTIONS: [[bool; 5]; NUM_NODES] = include_generated!("VALID_ACTIONS.rs");
pub static ACTION_DISTRIBUTIONS: [[[f32; 5]; NUM_NODES]; NUM_NODES] =
    include_generated!("ACTION_DISTRIBUTIONS.rs");
pub static DISTANCE_MATRIX: [[u8; NUM_NODES]; NUM_NODES] = include_generated!("DISTANCE_MATRIX.rs");
